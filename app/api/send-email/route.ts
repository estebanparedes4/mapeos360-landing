...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      ${empresa ? `
      <div class="field">
        <div class="label">🏢 Empresa o Rubro:</div>
      ...
      <div class="footer">
        ...
        <p>Responde directamente a esta dirección de email o contacta al cliente a: ${email}</p>
      </div>
    </div>
  </div>
</body>
    ...
    // Enviar email usando la API de SendGrid o similar
    // Por ahora, simulamos un envío exitoso
    // En producción, usarías un servicio real como SendGrid, Resend, etc.
    
    console.log('Email para enviar:', {
      to: 'comercialotec@otecachsservicios.cl',
      from: 'noreply@mapeos360.vercel.app',
      subject: `Nueva solicitud de asesoría de ${nombre}`,
      html: emailContent,
    })
